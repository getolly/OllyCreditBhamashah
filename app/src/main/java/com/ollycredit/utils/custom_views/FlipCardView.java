...
/**
 * Created by dilpreet on 19/11/17.
 */
...
public class FlipCardView extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs)
    {
        ...
        if (attrs != null)
        {
            ...
            final TypedArray attrArray = context.obtainStyledAttributes(attrs, R.styleable.flip_card_view, 0, 0);
            try {
                flipOnTouch = attrArray.getBoolean(R.styleable.flip_card_view_flipOnTouch, false);
                flipDuration = attrArray.getInt(R.styleable.flip_card_view_flipDuration, DEFAULT_FLIP_DURATION);
            } finally {
                attrArray.recycle();
            }
        }
        ...
        mSetRightOut.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                if (mFlipState == FlipState.FRONT_SIDE)
                {
                    ...
                    mCardBackLayout.setLayoutParams(new FrameLayout.LayoutParams(mCardFrontLayout.
                            getWidth(), mCardFrontLayout.getHeight()));
