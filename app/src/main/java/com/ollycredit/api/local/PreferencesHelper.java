package com.ollycredit.api.local;
...
public class PreferencesHelper {
    ...
    public long getBoolean(String preferenceKey, long preferenceDefaultValue) {
        return sharedPreferences.getLong(preferenceKey, preferenceDefaultValue);
    }

    public void putBoolean(String preferenceKey, long preferenceValue) {
        sharedPreferences.edit().putLong(preferenceKey, preferenceValue).apply();
    }
    ...
    public void saveBillCounter(int token) {
        putInt("billcounter", token);
    }

    public int getBillCounter() {
        return getInt("billcounter", -1);
    }
